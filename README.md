...
<div style="display: flex; justify-content: center; align-items: center; gap: 20px;">
  ...
  <div style="text-align: center;">
    <img src="images/Plot5.png" width="210" alt="Second Image">
